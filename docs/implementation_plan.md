...
| **充电器** | **18650 锂电池专用充电器** | 1 | 必买！没有它电池用完就废了。 |
| **数据线** | **Micro-USB 数据线** | 1 | 必买！注意是安卓老款扁口，必须能传数据（不能只是充电线）。 |

### 2.1 必备工具与辅材 (Tools & Consumables)
*这部分很容易被忽略，但没有它们你装不起来。*

| 名称 | 用途 | 备注 |
| :--- | :--- | :--- |
| **小号十字螺丝刀** | 拆卸玩具车外壳 | 必有。 |
| **电烙铁 & 焊锡丝** | 连接电机线 | 如果不想焊接，买“**免焊接线扣**”或“**接线端子**”，但焊接最稳固。 |
| **绝缘胶带 / 热缩管** | 包裹裸露电线 | 防止短路烧板子。 |
| **海绵双面胶 / 热熔胶枪** | 固定电路板 | 把 ESP32 和驱动板粘在车盖上。 |
| **万用表 (可选)** | 查电路通断 | 排除故障的神器，推荐买个几十块便宜的。 |
